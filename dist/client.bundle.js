...
var indexPage_1 = __webpack_require__(/*! ./components/index/indexPage */ "./src/client/components/index/indexPage.tsx");
var rewardPage_1 = __webpack_require__(/*! ./components/reward/rewardPage */ "./src/client/components/reward/rewardPage.tsx");
exports.App = function () {
    return React.createElement(react_router_dom_1.BrowserRouter, null, React.createElement("main", { className: 'container' }, React.createElement(react_router_dom_1.Route, { path: '/index', component: indexPage_1.IndexPage }), React.createElement(react_router_dom_1.Route, { path: '/reward/:key', component: rewardPage_1.RewardPage }), React.createElement(react_router_dom_1.Redirect, { from: '/', to: '/index' })));
};

/***/ }),

/***/ "./src/client/components/index/indexPage.tsx":
/*!***************************************************!*\
  !*** ./src/client/components/index/indexPage.tsx ***!
  \***************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! React */ "./node_modules/React/index.js");
var randomPhrase_1 = __webpack_require__(/*! ./randomPhrase */ "./src/client/components/index/randomPhrase.tsx");
var upload_1 = __webpack_require__(/*! ./upload */ "./src/client/components/index/upload.tsx");
exports.IndexPage = function () {
    return React.createElement("div", null, React.createElement("h1", null, "Share images with strangers"), React.createElement(randomPhrase_1.RandomPhrase, null), React.createElement(upload_1.Upload, null));
};

/***/ }),

/***/ "./src/client/components/index/randomPhrase.tsx":
/*!******************************************************!*\
  !*** ./src/client/components/index/randomPhrase.tsx ***!
  \******************************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var React = __webpack_require__(/*! React */ "./node_modules/React/index.js");
var phrases = ['Connecting strangers since 2018.', 'Social network for sharing images.', 'Instagram is nothing against us.', 'Better than YouTube.', 'We don\'t sell your personal data. Wait, we don\'t even have your personal information.', ':)'];
exports.RandomPhrase = function () {
    return React.createElement("p", null, phrases[Math.floor(Math.random() * phrases.length)]);
};

/***/ }),

/***/ "./src/client/components/index/upload.tsx":
/*!************************************************!*\
  !*** ./src/client/components/index/upload.tsx ***!
  \************************************************/
/*! no static exports found */
...
var Upload = /** @class */function (_super) {
    ...
    Upload.prototype.onFileChange = function (e) {
        var _this = this;
        this.setState({
        ...
        axios_1.default.post('/upload', form).then(function (response) {
    ...
    Upload.prototype.onRetryClick = function () {
        this.setState({
            uploadStatus: UploadStatus.WAITING,
            uploadError: null
        });
    ...
    Upload.prototype.render = function () {
        ...
        switch (this.state.uploadStatus) {
            case UploadStatus.WAITING:
                content = React.createElement("div", null, React.createElement("h1", null, "Upload an Image"), React.createElement("p", null, "After you upload your own image. You will see a image from a stranger."), React.createElement("input", { type: 'file', name: 'file', onChange: this.onFileChange }));
                break;
            case UploadStatus.UPLOADING:
                content = React.createElement("div", null, React.createElement("h1", null, "Uploading your image..."), React.createElement("p", null, "Be patient, this will not take long."));
                break;
            case UploadStatus.DONE:
                content = React.createElement("div", null, React.createElement("h1", null, "Image uploaded"), React.createElement(react_router_dom_1.Link, { to: '/reward/' + this.state.imageKey, className: 'btn' }, "Show me what you got!"));
                break;
            case UploadStatus.ERROR:
                content = React.createElement("div", null, React.createElement("h1", null, "Something went wrong!"), React.createElement("p", null, this.state.uploadError), React.createElement("a", { onClick: this.onRetryClick, className: 'btn btn-link' }, "Retry"));
                break;
        }
        return React.createElement("div", { className: 'jumbotron' }, content);
    };
    return Upload;
}(React.Component);
...
/***/ "./src/client/components/reward/rewardPage.tsx":
/*!*****************************************************!*\
  !*** ./src/client/components/reward/rewardPage.tsx ***!
  \*****************************************************/
/*! no static exports found */
...
var RewardPage = /** @class */function (_super) {
    ...
    RewardPage.prototype.render = function () {
        return React.createElement("div", null, React.createElement("h1", null, "Here is your reward"), React.createElement("div", { className: 'row' }, React.createElement("div", { className: 'col' }, React.createElement("img", { className: 'img-fluid', src: '/image/' + this.props.match.params.key }))), React.createElement("div", { className: 'row' }, React.createElement("div", { className: 'col' }, React.createElement(react_router_dom_1.Link, { to: '/index', className: 'btn' }, "Try again")), React.createElement("div", { className: 'row' })));
    };
    return RewardPage;
}(React.Component);
exports.RewardPage = RewardPage;
